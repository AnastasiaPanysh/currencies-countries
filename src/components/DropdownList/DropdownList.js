...
function DropdownList() {
  ...
  const [activeAbbreviation, setActiveAbbreviation] = useState('')
  ...
  function setActive(event) {
    ...
    setActiveAbbreviation(event.target.textContent)
  }
    ...
    <>
      <div className={style['listbox']}>
        <div className={style['contents']}>
          ...
          {/* <div className={style['country-abbreviation']}><p>{activeAbbreviation}</p></div> */}
        </div>
